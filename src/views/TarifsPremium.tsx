        ...
        <NavLayout disableContentContainer={true}>
            <ContentContainer style={{ maxWidth: "100%" }} className={classes.bkg}>
                <Typography className={classes.caption}>
                    QuickCells
                    <Typography className={clsx(classes.caption, classes.greenLetter, classes.leftAlign)}> Premium.</Typography>
                </Typography>
                <Container className={clsx(classes.flexContainer)}>
                    <Container className={clsx(classes.buttonGroup)}>
                        <Button className={clsx(classes.buttonStyle, classes.smallButton, classes.buttonTitleStyle, classes.marginConst)} color="primary">Je suis un Particuler</Button>
                        <Button className={clsx(classes.buttonStyle, classes.smallButton, classes.buttonTitleStyle, classes.marginConst)}>Je suis un Professionnel</Button>
                    </Container>
                </Container>
            </ContentContainer>
        </NavLayout>
